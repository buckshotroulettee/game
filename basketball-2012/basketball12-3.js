(function() {
    ...
    var ha = [],
        ...
        u = function() {
            ...
            ma && (window.requestAnimationFrame ? window.requestAnimationFrame(u) : window.oRequestAnimationFrame ? window.oRequestAnimationFrame(u) : window.mozRequestAnimationFrame ? window.mozRequestAnimationFrame(u) : window.msRequestAnimationFrame ? window.msRequestAnimationFrame(u) : window.webkitRequestAnimationFrame && window.webkitRequestAnimationFrame(u))
        },
        qa = function(a) {
            ka = v;
            la = a || null;
            window.addEventListener && (window.addEventListener("MozGamepadConnected", oa, !1), window.addEventListener("MozGamepadDisconnected", pa,
                !1));
            ...
            if (google) {
                var d = function() {
                    ...
                    e = function() {
                        ...
                        a && "hidden" != a.style.visibility && (a = google.msg && google.msg.listen, google.Ha && google.Ha.q && a && (a(106, d), c && a(94, c)))
                    };
                e();
                google.doodle && google.doodle.jesr || (ea("google.doodle.jesr", !0), google.raas && google.raas("doodle", {
                    init: function() {
                        e();
    ...
    var Fa = -1 != w.indexOf("Opera") || -1 != w.indexOf("OPR"),
        ...
        Ga = -1 != w.indexOf("Gecko") && -1 == w.toLowerCase().indexOf("webkit") && !(-1 != w.indexOf("Trident") || -1 != w.indexOf("MSIE")),
        ...
        Ja = function() {
            ...
            Ga ? b = /rv\:([^\);]+)(\)|;)/ : x ? b = /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/ : Ha && (b = /WebKit\/(\S+)/);
            b && (a = (a = b.exec(w)) ? a[1] : "");
        ...
        y = function(a) {
            ...
            if (!(b = Ka[a])) {
                b = 0;
                for (var c = xa(String(Ja)).split("."), d = xa(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                    var g = c[f] || "",
                        h = d[f] || "",
                        k = RegExp("(\\d*)(\\D*)", "g"),
                        wa = RegExp("(\\d*)(\\D*)", "g");
                    do {
                        ...
                        b = ya(0 == G[1].length ? 0 : parseInt(G[1], 10), 0 == H[1].length ? 0 : parseInt(H[1], 10)) || ya(0 == G[2].length,
                            0 == H[2].length) || ya(G[2], H[2])
                    } while (0 == b)
                }
                b = Ka[a] = 0 <= b
            }
    ...
    var Pa = function(a) {
            ...
            Oa[c] = b; - 1 != a.search("&ei=") || (d = "&ei=");
            a = "/gen_204?atyp=i&ct=doodle&cad=" + a + d + "&zx=" + p();
            /^http:/i.test(a) && "https:" == window.location.protocol ? delete Oa[c] : (b.src = a, Na = c + 1)
        },
        Oa = [],
        Na = 0;
    var Qa, Ra = 0 <= navigator.userAgent.indexOf("MSIE"),
        Ta = function(a) {
            for (var b = Sa, c = 0; c < b.length; c++)
                if (a === b[c]) return !0;
            return !1
        },
        z = function(a, b, c) {
        ...
        Ua = function() {
            var a = window.localStorage && window.localStorage.getItem("doodle-basketball-tooltip") || null;
        ...
        Wa = function() {
            ...
            window.WebFontConfig || (ea("WebFontConfig.google.families",
                a), a = document.createElement("script"), a.src = ("https:" == document.location.protocol ? "https" : "http") + "://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js", a.type = "text/javascript", a.async = "true", (document.getElementById("xjsc") || document.body).appendChild(a))
        },
        Xa = function(a) {
            if (window.google && window.google.log) {
                var b;
                Qa || (b = document.getElementById("hplogoved")) && (Qa = b.getAttribute("data-ved"));
                (b = Qa) && (a += "&ved=" + b);
        ...
        ab = function(a, b, c, d, e, f, g, h, k, wa, G) {
            if (a.o) {
                var H = a.i[b],
                    ...
                    na = g * na,
                    Zb = G || !1;
                c.drawImage(a.k.i, H[0] + d, H[1] + e, f, g, h - (Zb ? Yb / 2 : 0), k - (Zb ? na / 2 : 0), Yb, na)
            } else $a(a, function() {
    ...
    var bb = function() {
        ...
        cb = !1,
        fb = function(a) {
            cb || (db(a), a.k = 0, a.o = p(), a.i = window.setInterval(function() {
                eb(a)
            }, 16), eb(a))
        },
        B = function(a, b, c) {
    ...
    var rb = function(a) {
        ...
        tb = function(a, b, c, d, e) {
            ...
            b = a.i[f];
            b || (b = a.i[f] = [], a.k++);
            var g = sb(b, c, d, e); - 1 < g ? (a = b[g], a.X = !1) : (a = new pb(c, a.src, f, !!d, e), a.X = !1, b.push(a));
            return a
        },
        ub = function(a, b) {
            var c = b.type;
    ...
    var wb = "closure_lm_" + (1E6 * Math.random() | 0),
        ...
        zb = function(a, b, c, d, e) {
            ...
            if (a && a[nb]) a = a.listen(b, c, d, e);
                ...
                g || (a[wb] = g = new rb(a));
                c = tb(g, b, c, d, e);
                c.i || (d = Cb(), c.i = d, d.src = a, d.N = c, a.addEventListener ? a.addEventListener(b.toString(), d, f) : a.attachEvent(Db(b.toString()), d), yb++);
                a = c
            }
            return a
        },
        ...
        Fb = function(a, b, c, d, e) {
            ...
            else c = Ab(c), a && a[nb] ? a.unlisten(b, c, d, e) : a && (a = Bb(a)) && (b = vb(a, b, c, !!d, e)) && Gb(b)
        },
        Gb = function(a) {
            ...
            var c = a.type,
                d = a.i;
            b.removeEventListener ? b.removeEventListener(c, d, a.W) : b.detachEvent && b.detachEvent(Db(c), d);
            yb--;
    ...
    var Lb = function(a, b) {
        ...
        if (c)
            for (k = 0; !e.o && k < c.length; k++) h = e.k = c[k], g = Kb(h, f, !1, e) && g;
        return g
    };
    ...
    F.prototype.unlisten = function(a, b, c, d) {
        ...
        if (a in e.i) {
            var f = e.i[a];
            b = sb(f, b, c, d); - 1 < b ? (qb(f[b]), za.splice.call(f, b, 1), 0 == f.length && (delete e.i[a], e.k--), e = !0) : e = !1
        } else e = !1;
        return e
    };
    ...
    I.prototype.unlisten = function(a, b, c, d, e) {
        ...
        else c = c || this.handleEvent, e = e || this.A || this, c = Ab(c), d = !!d, b = a && a[nb] ? vb(a.K, String(b), c, d, e) : a ? (a = Bb(a)) ? vb(a, b, c, d, e) : null : null, b && (Gb(b), delete this.s[b.ta]);
        return this
    };
    ...
    var Sb = function(a, b, c, d, e) {
        ...
        this.F = c;
        this.B = d;
        e && (this.p && this.unlisten(this.p, "action", this.v), e && (this.p = new Nb(e), a = da(mb, this.p), this.o ? a.call(void 0) : (this.k || (this.k = []), this.k.push(a)), this.v = n(this.H, this), this.listen(this.p, "action", this.v)))
    };
    q(Sb, I);
    Sb.prototype.H = function() {
        Tb() && -1 == w.indexOf("Trident") && -1 == w.indexOf("MSIE") && window.gapi && window.gapi.load ? (window.gapi.load("share", n(this.w, this)), Xa("gplus,li")) : (window.open("https://plus.google.com/share?url=" + this.D), Xa("gplus,lo"))
    };
    var Tb = function() {
    ...
    var Ub, Vb, v, Wb, Xb, J, $b, ac, bc, K, cc, dc, ec, fc, gc, L, M, N, O, hc, P, ic, Q, Sa = [32, 13],
        jc = [],
        kc = !1,
        R = 0,
        lc = [],
        ...
        tc = function(a) {
            var b = nc(1),
                c = nc(2) + " \u2014 " + nc(0) + ": ";
            Wb = "basketball";
            var d = "https://"+window.location.hostname+"/game/basketball-2012/";
            z("img").src = "./olympics12-hp-sprite.png";
            P = z("div", "hplogo_sc");
            Vb = z("div", "hplogo_sb");
            Ub = z("span", "hplogo_sbt", "hplogo_sse");
            Vb.appendChild(Ub);
            for (var e = 0; 3 > e; e++) lc[e] = z("div", "hplogo_sm"), Vb.appendChild(lc[e]);
            P.appendChild(Vb);
            e = function(a) {
                a =
                    z("div", a);
        ...
        S = function() {
            ...
            b = Math.min(40, b);
            N || bc && 18E4 < a - bc ? kc = !1 : !mc && (void 0)(a, b) ?
                (window.requestAnimationFrame ? window.requestAnimationFrame(S, v) : window.oRequestAnimationFrame ? window.oRequestAnimationFrame(S) : window.mozRequestAnimationFrame ? window.mozRequestAnimationFrame(S) : window.msRequestAnimationFrame ? window.msRequestAnimationFrame(S) : window.webkitRequestAnimationFrame ? window.webkitRequestAnimationFrame(S, v) : window.setTimeout(S, 16), ac = a, kc = !0) : kc = !1
        },
        sc = function(a, b, c) {
            window.google && window.google.log && window.google.log("doodle-basketball", "p:" + a + ",s:" + ("undefined" != typeof b ?
                b : "_") + ",nc:" + ("undefined" != typeof c ? c : "_") + ",d:" + R + ",")
        },
        uc = function(a, b) {
            return function() {
                a.className = b
        ...
        wc = function(a) {
            vc();
            (37 == a.keyCode || 39 == a.keyCode || 38 == a.keyCode || 40 == a.keyCode || Ta(a.keyCode)) && a.preventDefault();
    ...
    U.prototype.o = function(a) {
        ...
        if (0 == b) return null;
        var c = ((this.start.y - a.start.y) * (a.end.x - a.start.x) - (this.start.x - a.start.x) * (a.end.y - a.start.y)) / b;
        a = ((this.start.y - a.start.y) * (this.end.x - this.start.x) - (this.start.x - a.start.x) * (this.end.y - this.start.y)) / b;
        return 0 <= c && 1 >= c && 0 <= a && 1 >= a ? new T(this.start.x + c * (this.end.x - this.start.x), this.start.y + c * (this.end.y - this.start.y)) :
            null
    };
    ...
    Fc.prototype.V = function() {
        var a = Math.max(.5, 1 - (180 - this.y) / 180),
            b = a - .25,
            c = V;
        c.save();
    ...
    Kc.prototype.C = function() {
        if (this.i.length) {
            for (var a = Za(this.s, 11), b = null, c = this.i.length - 1, d; d = this.i[c]; c--)
                if (d.x + d.r < this.o || d.x - d.r > this.o + a.width || d.y - d.r > this.k + a.height) this.i.splice(c, 1);
                else if (!b || d.y > b.y) b = d;
            b && (a = b.y + b.r < this.k ? 0 : Math.min(Math.floor((b.y + b.r - this.k) / (a.height + b.r) * this.p.length), this.p.length - 1), A(this.v, this.p[a], V, this.o, this.k))
        }
    ...
    var Lc = [
        ...
        Tc = function(a) {
            switch (a.k) {
                ...
                case 1:
                    var b = Vc(a, Mc);
                    b ? 2 == b.U && a.o ? (a.o = 0, Wc(a, !0)) : (b.U == Math.ceil(Mc.length / 2) && (a.i = Jc(a.J)), Uc(a, b)) : X(a, 0);
                    break;
                case 2:
                    Xc(a, Nc);
                    break;
    ...
    Rc.prototype.V = function() {
        ...
        b.save();
        var c = .3;
        if (3 == this.k && 7 <= this.H) var d = Math.min((this.H - 7) / (Oc.length - 7 - 4), 1),
            c = c * (Math.cos((.5 + d) * Math.PI) + 1);
    ...
    Rc.prototype.C = function() {
        0 == this.k || 1 == this.k ? A(this.F, this.D, V, this.s, this.v) : A(this.I, this.D, V, this.s, this.v);
    ...
    bd.prototype.C = function() {
        ...
        24 == b && (b = Za(this.i, 22), a.save(), a.translate(this.k + this.A, this.v + this.B), a.rotate(this.s), A(this.i, 22, V, -b.width /
            2 - (this.A - 36), -b.height / 2 - (this.B - 36)), a.restore());
        a.globalAlpha = 1
    };
    ...
    var fd = 1 / 30,
        gd = 1 / 60,
        hd = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(a) {
        ...
        id = function(a, b) {
            ...
            this.o = [];
            this.wa = [new U(80, 10, 80, 70), new T(132,
                62)];
            ...
            cc = c;
            v.onkeydown = wc;
            v.style.cursor = "pointer"; - 1 != navigator.userAgent.indexOf("Opera") && (v.onkeypress = xc);
            Y.onmouseover = n(this.oa,
                this, !0);
        ...
        kd = function(a) {
            ...
            A(a.w, 0, V, 0, 0);
            jd(a, a.p, 340);
            5 <= Z(a) || 0 == Z(a) ? jd(a, Z(a), 431) : 1 == dd(Math.round(Z(a) / .25), 2) && jd(a, Z(a), 431);
            a.G.C();
            a.i.V();
            var b, c;
                ...
                for (a > fd && (a = fd); a >= gd;) {
                    ...
                    if (1 <= this.G.o && !this.s) this.D = !1;
                        ...
                        if (Z(this)) {
                            ...
                            if (0 < this.A && null == this.i.i || null != this.i.i && 3 == this.i.k || 50 > this.A) c = Math.min(this.A, 200 * b), this.v.k = this.v.k + c, this.A -= c
                        }
                        c = this.G;
                        ...
                        if (c.o != c.i) {
                            var d = c.i - c.o;
                            c.o = Math.min(1, Math.max(0, c.o + d / Math.abs(d) * (1E3 / (c.o < c.i ? 200 : 100)) * b))
                        }
                        c = this.i;
                        if (c.o && 2 == c.k) {
                            var d = W() - c.o,
                                e = 1;
                            1E3 < d ? (c.A = Math.round(4 * Math.random() - 2), c.B = Math.round(4 * Math.random() - 2)) : e = d / 1E3;
                            c.i.k = e
                        } else c.A = c.B = 0;
                        Tc(c);
                        c = this.v;
                        e = c.i.i;
                        c.i.x - c.i.r <= c.k && (c.i.x = c.k + c.i.r, e.x = .25 * -e.x);
                        d = c.i;
                        ...
                        for (d = void 0; this.o[c]; c--) {
                            ...
                            k && (f = Cc(k, e).length() / Cc(g, e).length() * f * .9, g = Hc(e, f), e.s = !0);
                            if (k = md(this, e, g)) h = e, g = Cc(k, g), k = g.length(), g = new T(g.x / k, g.y / k), k = Math.abs(Dc(g, h.i)), h.i.x -= 2 * g.x * k, h.i.y -= 2 * g.y * k, h.i.x *= .6, h.i.y *= .6, 15 > Math.abs(h.i.y) && (h.i.y = 0), 0 > Math.abs(h.i.x) && (h.i.x = 0), e.s = !0;
                            Gc(e, f);
                            0 < e.i.y && !e.w && e.o(this.ma) && (this.ka.i.push(e), e.w = !0, this.p += 3 <= Math.floor(this.L / 3) ? 3 : 2, this.L++, 0 == dd(this.L, 4) && (this.I = this.A = 50));
                            (0 > d.x +
                                d.r || 530 < d.x - d.r) && this.o.splice(c, 1)
                        }
                        this.s && 5E3 < (new Date).getTime() - this.H && 1 != this.k.i && (this.la || sc(3), this.la = !0, this.k.i = 1);
                        if (0 >= Z(this)) {
                            ...
                            c = this.i;
                            2 == c.k || 3 == c.k ? nd(this, !0) : b && this.B ? (clearTimeout(this.B), this.B = 0) : b || this.B || (this.B = setTimeout(n(this.Ca, this), 500))
                        }
                    }
                    a -= gd
                }
    ...
    id.prototype.Ca = function() {
        ...
        setTimeout(n(function() {
            ...
            Xb.F = ic + b;
            e || (e = Wb);
            Xb.B = "https://"+window.location.hostname+"/game/basketball-2012/" + e + "12-hp-share" + d + ".png";
            Ub.textContent = b;
            for (b = 0; 3 > b; b++) lc[b].className = b < d ? "hplogo_smg" : "hplogo_smh";
            P.style.display = "";
            fb(Q);
            this.D = !1
        }, this), 1500)
    ...
    var pd = function(a) {
        ...
        Ua() || (window.localStorage && window.localStorage.setItem("doodle-basketball-tooltip", "1"), a.k.i = 1);
        ld(a);
        Wa();
        a.S || (a.S = !0, ia[2] = Sa[0], ia[4] = Sa[0], ia[5] = Sa[0], ia[6] = Sa[0], qa(function() {
            2 != R && (R = 2)
        }))
    };
    l = id.prototype;
    ...
    l.za = function(a) {
        if (this.s && Y) {
            var b;
            b = (a = a || window.event) ? (b = a.targetTouches && a.targetTouches[0]) && void 0 !== b.pageX ? [b.pageX, b.pageY] : void 0 !== a.clientX ? [a.clientX + ("rtl" == document.dir ? -1 : 1) * (document.body.scrollLeft || document.documentElement.scrollLeft || 0), a.clientY + (document.body.scrollTop || document.documentElement.scrollTop || 0)] : void 0 !== a.pageX ? [a.pageX, a.pageY] : [0, 0] : [0, 0];
            var c;
            a = Y;
            var d = c = 0;
            if (a) {
            ...
            b = b[1] - c[1];
            if (c =
                1 == this.k.i) c = this.k, d = Za(c.s, 8), c = a >= c.k && b >= c.p && a <= c.k + d.width && b <= c.p + d.height;
            c || qd(this)
        }
    };
    l.Aa = function() {
        ...
        nd = function(a, b) {
            if (b || a.s && !(0 >= Z(a))) {
                ...
                if (c.o && 2 != c.k) c.o = 0;
                    ...
                    var f = W() - c.o;
                    c.G++;
                    !c.o || 200 > f && 2 > c.G || (c.G = 0, c.S = Math.min(f / 1E3, 1), c.o = 0, X(c, 3), c.O = d, c.T = e)
                }
            }
        };
    ...
    var rd = !1,
        ...
        Y = null,
        V = null,
        td = new Ya("./basketball12-hp-init.png", [
            [0, 725, 530, 207],
            [0, 710, 236, 12],
            [71, 565, 236, 52],
            [94, 454, 30, 30],
        ...
        ud = new Ya("./basketball12-hp-anim.png", [
            [0, 1756, 68, 129],
            [0, 1888, 68, 129],
            [0, 3724, 68, 129],
            [0, 8820, 68, 129],
    ...
    (function(a, b, c) {
        ...
        !rd && (cb = !1, (sd = document.getElementById("hplogo")) && (Y = document.getElementById("hplogo-c")) && Y.getContext && (V = Y.getContext("2d"))) && (rd = !0, v = sd, google.doodle && google.doodle.alt && sd.setAttribute("aria-label", google.doodle.alt), $a(td, function() {
            vd = new id(td, ud);
            ld(vd);
            $a(ud, function() {})
        }))
